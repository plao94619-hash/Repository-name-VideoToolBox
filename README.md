...
- Universal-Media-Toolbox-Setup-1.3.0.exe：安装版
- Universal-Media-Toolbox-Portable-1.3.0.zip：免安装便携版
- SHA256SUMS.txt：校验值
...
外观菜单可选择跟随系统、浅色或深色；窗口会记住上次的大小与位置。任务完成后，双击输出文件列或右键选择“复制输出路径”；失败行可双击状态或右键选择“查看错误详情”。文件较多或窗口较小时，内容区域可以滚动，底部开始与取消按钮始终可见。
